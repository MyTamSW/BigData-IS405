...
def XGBoost():
    ...
    model = XGBClassifier(use_label_encoder=False, n_estimators=111, reg_lambda=0.171, reg_alpha=42, min_child_weight=1, max_depth=14, gamma=3.375, colsample_bytree=0.749, seed=2)
