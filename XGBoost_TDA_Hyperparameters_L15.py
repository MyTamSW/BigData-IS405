...
def XGBoost():
    ...
    dataset = pd.read_csv('Dataset_Statistics_L15_random.txt', header = None)
    ...
    model = XGBClassifier(use_label_encoder=False, n_estimators=156, reg_lambda=0.071, reg_alpha=170, min_child_weight=8, max_depth=8, gamma=2.935, colsample_bytree=0.722, seed=9)
